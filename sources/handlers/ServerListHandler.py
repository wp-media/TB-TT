...
class ServerListHandler():
    ...
    def get_groupone_ipv4(self):
        ...
        group_one_ips = "46.30.211.168 46.30.212.76 46.30.212.77 46.30.212.78 46.30.212.79 46.30.211.69 46.30.212.200 46.30.212.201 46.30.212.202 46.30.212.203 46.30.211.203 46.30.212.204 46.30.212.205 46.30.212.206 46.30.212.207 46.30.211.236 5.249.224.8 5.249.224.9 5.249.224.10 5.249.224.11"  # pylint: disable=line-too-long
        group_one_ips = group_one_ips.replace(" ", "\n")
        return group_one_ips
